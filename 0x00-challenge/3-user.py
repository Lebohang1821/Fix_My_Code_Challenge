...
class User():
    ...
    def __init__(self):
        ...
        self.__password = None  # Fix: Initialize __password here
    ...
    def password(self, pwd):
        ...
        """
        if pwd is None or not isinstance(pwd, str):  # Fix: Use isinstance for type checking
    ...
    def is_valid_password(self, pwd):
        ...
        """
        if pwd is None or not isinstance(pwd, str) or self.__password is None:  # Fix: Use isinstance for type checking
            return False
        return hashlib.md5(pwd.encode()).hexdigest().lower() == self.__password  # Fix: Use lower() for comparison
